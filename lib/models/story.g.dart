...
void _storySerialize(
  ...
  writer.writeString(offsets[2], object.urlImage);
}
...
Story _storyDeserialize(
  ...
  object.urlImage = reader.readString(offsets[2]);
  return object;
}
...
extension StoryQueryFilter on QueryBuilder<Story, Story, QFilterCondition> {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'urlImage',
        value: '',
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> urlImageIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'urlImage',
        value: '',
...
extension StoryQuerySortBy on QueryBuilder<Story, Story, QSortBy> {
  ...
  QueryBuilder<Story, Story, QAfterSortBy> sortByUrlImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'urlImage', Sort.asc);
    });
  }

  QueryBuilder<Story, Story, QAfterSortBy> sortByUrlImageDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension StoryQuerySortThenBy on QueryBuilder<Story, Story, QSortThenBy> {
  ...
  QueryBuilder<Story, Story, QAfterSortBy> thenByUrlImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'urlImage', Sort.asc);
    });
  }

  QueryBuilder<Story, Story, QAfterSortBy> thenByUrlImageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'urlImage', Sort.desc);
    });
  }
...
extension StoryQueryWhereDistinct on QueryBuilder<Story, Story, QDistinct> {
  ...
  QueryBuilder<Story, Story, QDistinct> distinctByUrlImage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension StoryQueryProperty on QueryBuilder<Story, Story, QQueryProperty> {
  ...
  QueryBuilder<Story, String, QQueryOperations> urlImageProperty() {
    return QueryBuilder.apply(this, (query) {
